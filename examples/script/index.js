...
require(['../../src/js/require-config'],function(){
    require(['juan','rgbaster','iphone-inline-video'],function(juanchen,RGBaster,enableInlineVideo){
        ...
        (function () {
            //1移动的对象
            var moveObjArr = [
                {type: "img", src: "./assets/imgs/moveBallRed.png"},
                {type: "img", src: "./assets/imgs/moveBallRed.png"},
                {type: "img", src: "./assets/imgs/moveBallGreen.png"},
                {type: "img", src: "./assets/imgs/moveBallRed.png"},
                {type: "img", src: "./assets/imgs/moveBallGreen.png"},
        ...
        //计算容器滚动了多少，
        juanchen.tools.whenScroll({
            type:"calcWraperScroll",
            $scrollContainer: $(window), // 滚动的容器
